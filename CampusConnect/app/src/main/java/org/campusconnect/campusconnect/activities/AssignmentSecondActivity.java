...
public class AssignmentSecondActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    private DrawerLayout drawer;
    private final AppCompatActivity activity = AssignmentSecondActivity.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_assignmentssecond);
        ...
        toggle.syncState();
        Button button7 = findViewById(R.id.btn2_1);
        Button button8 = findViewById(R.id.btn2_2);
    }
